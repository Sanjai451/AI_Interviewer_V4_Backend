...
export async function createInterview(req, res, next) {
  try {
    const { candidateId, jobRole, jobDescription, techStack, mode, difficulty, numQuestions, durationMinutes, jdAnalysis } = req.body;
...
[{
  ...
  "questionType": "conceptual|problem-solving|system-design|behavioral"
    ...
    if (!Array.isArray(generatedQs)) throw new Error("Invalid questions format from AI");
